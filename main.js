...
function createGameCard(game, basePath = '') {
  ...
  const fallback = BASE_PATH + 'images/placeholder.jpg';
  const detailUrl= basePath + BASE_PATH + 'pages/game-detail.html?id='+ encodeURIComponent(game.id);
    ...
    featuredEl.innerHTML = `
      <div class="featured-image">
        <img src="${escHtml(getGameImage(featured))}" alt="${escHtml(featured.title)}"
          onerror="this.onerror=null;this.src='${BASE_PATH}images/placeholder.jpg'">
      </div>
  ...
  list.innerHTML = games.map(game => {
    ...
    <div class="admin-game-item" id="admin_${escHtml(game.id)}">
      <img class="admin-game-thumb"
        ...
        onerror="this.onerror=null;this.style.background='var(--bg-dark)';this.src='${BASE_PATH}images/placeholder.jpg'">
...
const basePath  = BASE_PATH + (isInPages ? 'pages/../' : '');
